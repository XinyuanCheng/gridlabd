...
PROPERTYSPEC property_type[_PT_LAST] = {
	...
	{"char8", "string", "", sizeof(char8), 8, convert_from_varchar,convert_to_varchar,NULL,varchar_create,NULL,convert_to_varchar,{TCOPS(string)},},
	{"char32", "string", "", sizeof(char32), 32, convert_from_varchar,convert_to_varchar,NULL,varchar_create,NULL,convert_to_varchar,{TCOPS(string)},},
	{"char256", "string", "", sizeof(char256), 256, convert_from_varchar,convert_to_varchar,NULL,varchar_create,NULL,convert_to_varchar,{TCOPS(string)},},
	{"char1024", "string", "", sizeof(char1024), 1024, convert_from_varchar,convert_to_varchar,NULL,varchar_create,NULL,convert_to_varchar,{TCOPS(string)},},
